...
export class ConnectFourBloomtech__gamesResult {
  value0: Address;
  value1: Address;
  value2: BigInt;
  value3: i32;
...
export class ConnectFourBloomtech extends ethereum.SmartContract {
  static bind(address: Address): ConnectFourBloomtech {
    return new ConnectFourBloomtech("ConnectFourBloomtech", address);
  }
  ...
  games(param0: i32): ConnectFourBloomtech__gamesResult {
    ...
    return new ConnectFourBloomtech__gamesResult(
      result[0].toAddress(),
      result[1].toAddress(),
      result[2].toBigInt(),
      result[3].toI32(),
  ...
  try_games(
    param0: i32
  ): ethereum.CallResult<ConnectFourBloomtech__gamesResult> {
    let result = super.tryCall(
      "games",
      "games(uint16):(address,address,uint256,uint8,bool)",
      [ethereum.Value.fromUnsignedBigInt(BigInt.fromI32(param0))]
    ...
    return ethereum.CallResult.fromValue(
      new ConnectFourBloomtech__gamesResult(
        value[0].toAddress(),
        value[1].toAddress(),
        value[2].toBigInt(),
        value[3].toI32(),
